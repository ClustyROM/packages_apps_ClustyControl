...
import com.clustycontrol.tools.Voltage;
import com.clustycontrol.tools.VoltageControl;
import com.clustycontrol.util.CMDProcessor;
import com.clustycontrol.util.KernelUtils;
...
public class BootService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        try{
    		...
    		bwriter.close();
    		Intent i = new Intent();
    		i.setAction("com.clustycontrol.FCHARGE_CHANGED");
